...
// 精密装配机阵列：配方继承
# 精密装配机 -> 精密装配机阵列
RecipeAdapterBuilder.create("APAC", "modularmachinery:board_assembly_room")
...
MachineModifier.setMaxThreads("space_elevatormk3", 0);
