...
radiation(1,[<nuclearcraft:uranium:10>,<super_solar_panels:crafting:26>],[<nuclearcraft:neptunium:5>,<avaritia:resource:2>]);
radiation(2,[<nuclearcraft:uranium:10>,<super_solar_panels:crafting:26>*2,<avaritia:resource:2>*2],[<nuclearcraft:plutonium:15>]);
radiation(3,[<nuclearcraft:uranium:10>,<super_solar_panels:crafting:26>*3,<avaritia:resource:2>*2],[<nuclearcraft:americium:10>]);
radiation(4,[<nuclearcraft:uranium:10>,<super_solar_panels:crafting:26>*6,<avaritia:resource:2>*8],[<nuclearcraft:californium:15>]);