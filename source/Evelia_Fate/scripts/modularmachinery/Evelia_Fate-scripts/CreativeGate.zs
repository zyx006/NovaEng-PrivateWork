...
RecipeBuilder.newBuilder("EnergyLiquefy","transcendentmattergenerator",1000)
    ...
    .addCatalystInput(<botania_tweaks:compressed_tiny_potato_8>,
        ...
        [RecipeModifierBuilder.create("modularmachinery:duration","input",2,1,false).build(),RecipeModifierBuilder.create("modularmachinery:fluid","output",3,1,false).build()]
    ).setChance(0)
    .addCatalystInput(<contenttweaker:world_energy_core>*4,
        ["一切能量最本源的所在，有着不可思议的力量","可发电时间变为原本的1.5倍，发电量变为原来的2倍"],
        [RecipeModifierBuilder.create("modularmachinery:duration","input",1.5,1,false).build(),RecipeModifierBuilder.create("modularmachinery:fluid","output",2,1,false).build()]
    ).setChance(0)
    ...
    .addCatalystInput(<appliedenergistics2:creative_energy_cell>,
        ...
        [RecipeModifierBuilder.create("modularmachinery:duration","input",2,1,false).build()]
    ).setChance(0)
    ...
    .addCatalystInput(<modularmachinery:ultra_zero_point_vacuum_displacer_controller>,
        ...
        [RecipeModifierBuilder.create("modularmachinery:duration","input",9,1,false).build(),RecipeModifierBuilder.create("modularmachinery:fluid","output",4,1,false).build()]
    ).setChance(0)
    .addCatalystInput(<deepmoblearning:data_model_inf7yentr60py>.withTag({tier: 4}),
        ...
        [RecipeModifierBuilder.create("modularmachinery:duration","input",8,1,false).build(),RecipeModifierBuilder.create("modularmachinery:fluid","output",8,1,false).build()]
    ).setChance(0)
    ...
    .addCatalystInput(<modularmachinery:light-speed_material_accelerator_factory_controller>,
        ...
        [RecipeModifierBuilder.create("modularmachinery:duration","input",3,1,false).build(),RecipeModifierBuilder.create("modularmachinery:fluid","output",5,1,false).build()]
    ).setChance(0)
    .addCatalystInput(<psicosts:creative_cell>,
        ["无穷无尽的ψ能量！你可以随意地挥霍它","可发电时间变为原来的2倍，发电量变为原来的2倍"],
        [RecipeModifierBuilder.create("modularmachinery:duration","input",2,1,false).build(),RecipeModifierBuilder.create("modularmachinery:fluid","output",2,1,false).build()]
    ).setChance(0)
    .addCatalystInput(<bloodmagic:sacrificial_dagger:1>,
        ["血液是从哪里来的？有趣的问题","可发电时间变为原来的4倍，发电量变为原来的4倍"],
        [RecipeModifierBuilder.create("modularmachinery:duration","input",4,1,false).build(),RecipeModifierBuilder.create("modularmachinery:fluid","output",4,1,false).build()]
    ).setChance(0)
    .addCatalystInput(<modularmachinery:melonfusion_controller>,
        ["这是神明吗？毫无疑问","可发电时间变为原来的5倍，发电量变为原来的10倍"],
        [RecipeModifierBuilder.create("modularmachinery:duration","input",5,1,false).build(),RecipeModifierBuilder.create("modularmachinery:fluid","output",10,1,false).build()]
    ).setChance(0)
...
RegistryHyperNet.addDataProcessorType(DataProcessorType.create("creativecomputer", 200 * 1000 * 1000,
        // 热量散发量 过热阈值
        440000,      2000000000)
        .addRadiatorIngredient(900000, [<liquid:crystalloid> * 50], [<liquid:liquid_energy> * 1])
);