...
recipes.addShaped(<modularmachinery:deepmelon_controller>, 
    [
        ...
        [<mekanism:machineblock3:7>, <mekanismmultiblockmachine:advanced_electrolysis_core>, <mekanism:machineblock3:7>], 
...
recipes.addShaped(<modularmachinery:ethenecontroller_controller>,
    [
        [<mekanism:energycube>, <mekanism:controlcircuit:3>, <mekanism:energycube>],
        [<mekanism:controlcircuit:3>, <mekanismgenerators:generator:3>, <mekanism:controlcircuit:3>], 
        [<modularmachinery:blockupgradebus>, <mekanism:controlcircuit:3>, <modularmachinery:blockupgradebus>]
    ]
);
