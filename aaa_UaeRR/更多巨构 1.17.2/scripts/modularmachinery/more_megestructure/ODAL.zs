...
RecipeBuilder.newBuilder("ODAL_SD1", "odal_sd",200)
        ...
        .addInput(<contenttweaker:world_energy_core> * 64).setChance(0)
...
RecipeBuilder.newBuilder("ODAL_AR2", "odal_ar",200)
        ...
        .addInput(<contenttweaker:additional_component_3> * 64).setChance(0)
        .addInput(<contenttweaker:superluminal_core> * 1).setChance(0)
